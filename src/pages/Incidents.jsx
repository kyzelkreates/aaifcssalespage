...
// ─── Demo data (shown when Supabase table not yet seeded) ─────
const DEMO = [
  { id: '1', title: 'Rear-end collision on A1', type: 'accident',  severity: 'high',     status: 'investigating', driver_name: 'J. Smith',  vehicle_reg: 'AB12 CDE', location: 'A1 Northbound, Junction 12', description: 'Minor rear-end collision with another vehicle. No injuries. Both vehicles driveable.', injuries: false, property_damage: true,  incident_date: new Date(Date.now() - 3600000 * 6).toISOString(), created_at: new Date(Date.now() - 3600000 * 6).toISOString() },
  { id: '2', title: 'Engine warning light — Unit 7', type: 'breakdown', severity: 'medium', status: 'resolved',   driver_name: 'A. Jones',  vehicle_reg: 'XY34 FGH', location: 'M6 Services, Keele',         description: 'Engine warning light illuminated. Vehicle recovered. Sensor fault — no mechanical damage.', injuries: false, property_damage: false, incident_date: new Date(Date.now() - 3600000 * 18).toISOString(), created_at: new Date(Date.now() - 3600000 * 18).toISOString() },
  { id: '3', title: 'Speeding event — 92 km/h in 70 zone', type: 'near_miss', severity: 'critical', status: 'open', driver_name: 'B. Taylor', vehicle_reg: 'PQ56 IJK', location: 'M25 Clockwise, J15',       description: 'AI speed alert triggered. Driver counselling required.', injuries: false, property_damage: false, incident_date: new Date(Date.now() - 7200000).toISOString(), created_at: new Date(Date.now() - 7200000).toISOString() },
  { id: '4', title: 'Cargo damage reported at delivery', type: 'cargo_damage', severity: 'medium', status: 'open', driver_name: 'C. Brown', vehicle_reg: 'LM78 NOP', location: 'London Depot, E1W',         description: 'Customer reported 2 pallets damaged on arrival. Cause under investigation.', injuries: false, property_damage: true,  incident_date: new Date(Date.now() - 86400000).toISOString(), created_at: new Date(Date.now() - 86400000).toISOString() },
  { id: '5', title: 'Icy conditions near miss', type: 'weather', severity: 'low', status: 'closed', driver_name: 'D. Wilson', vehicle_reg: 'QR90 STU', location: 'A66 Stainmore Pass',                    description: 'Driver reported near-loss-of-control on black ice. No incident but logged.', injuries: false, property_damage: false, incident_date: new Date(Date.now() - 86400000 * 3).toISOString(), created_at: new Date(Date.now() - 86400000 * 3).toISOString() },
]
...
export default function Incidents() {
  ...
  const load = useCallback(async () => {
    setLoading(true)
    try { setIncidents(await fetchIncidents({ severity: sevFilter || undefined, status: stsFilter || undefined })) }
